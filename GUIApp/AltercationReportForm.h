...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AltercationReportForm::typeid));
			...
			this->btnEnviar->Location = System::Drawing::Point(52, 347);
			...
			this->btnVolver->Location = System::Drawing::Point(251, 347);
			...
			this->label4->Location = System::Drawing::Point(24, 284);
			...
			this->txtDescription->Size = System::Drawing::Size(227, 179);
			...
			// btnCargarImagen
			// 
			this->btnCargarImagen->Location = System::Drawing::Point(291, 241);
			...
			// txtLugar
			// 
			this->txtLugar->Location = System::Drawing::Point(256, 307);
			...
			// dtpFecha
			// 
			this->dtpFecha->Location = System::Drawing::Point(28, 307);
			...
			this->ClientSize = System::Drawing::Size(484, 415);
